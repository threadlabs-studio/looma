...
| --- | --- | --- |
| Layout | `ui-stack`, `ui-cluster`, `ui-grid`, `ui-container`, `ui-switcher`, `ui-sidebar`, `ui-reel`, `ui-separator` | Same names in PascalCase |
...
| Display and app shell | `ui-avatar`, `ui-avatar-group`, `ui-badge`, `ui-callout`, `ui-list`, `ui-list-item`, `ui-toast-region`, `ui-search-shell`, `ui-search-result-row`, `ui-top-bar` | Same names in PascalCase |
