...
| Tooltip | `Tooltip`, `ToggleTip`, contextual help | trigger by focus/hover, delay, placement, disabled trigger behavior | Shipped as `ui-tooltip` | Extend: plan placement + delay tokens/options |
