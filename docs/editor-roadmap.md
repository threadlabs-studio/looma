...
- **Current open defects:** see [Editor Bugs](./editor-bugs.md) for the active table-picker anchoring, table-grid interaction, table overlay UX, and toolbar icon rendering issues found during real Knit usage.
