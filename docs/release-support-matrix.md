...
Release 1 is a public npm **Candidate `0.1.14`** for the smallest Looma surface
...
| --- | --- | --- |
| Exact source inventory | Source-derived classification and projection gate passing for all 44 tags | Must stay clean through publication |
...
| Packed package | One local `@threadlabs/looma@0.1.14` tarball passes content/export/hash inspection | License approval, clean protected build, and external/Knit fixtures remain |
