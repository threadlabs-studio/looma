...
| Packed package | One local `@threadlabs/looma@0.6.0-rc.2` tarball passes content/export/hash inspection | License approval, clean protected build, and external/Knit fixtures remain |
