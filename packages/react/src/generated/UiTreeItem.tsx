...
export function UiTreeItem(props: UiTreeItemProps) {
  ...
  const componentProps: Record<string, unknown> = { "accepts": prop0, "container": prop1, "disabled": prop2, "dragType": prop3, "dropDepth": prop4, "dropScope": prop5, "expanded": prop6, "itemId": prop7, "label": prop8, "selected": prop9, "sortable": prop10, "subtreeDepth": prop11 };
