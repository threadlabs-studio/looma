  ...
  return (
    <div {...nativeProps} data-component="ui-tree-item" data-component-root="ui-tree-item" role="treeitem" data-drop-scope={prop5 ?? undefined} data-accepts={prop0 ?? undefined} ref={setRoot}>
      ...
      <button className="drag-handle" part="drag-handle" type="button" data-component="ui-tree-item">
        <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-component="ui-tree-item">
          <circle cx="9" cy="12" r="1" data-component="ui-tree-item"></circle>
<circle cx="9" cy="5" r="1" data-component="ui-tree-item"></circle>
<circle cx="9" cy="19" r="1" data-component="ui-tree-item"></circle>
<circle cx="15" cy="12" r="1" data-component="ui-tree-item"></circle>
<circle cx="15" cy="5" r="1" data-component="ui-tree-item"></circle>
<circle cx="15" cy="19" r="1" data-component="ui-tree-item"></circle>
        </svg>
      </button>
