...
export function UiSidebar(props: UiSidebarProps) {
  ...
  const componentProps: Record<string, unknown> = { "align": props["align"], "gap": props["gap"], "maxWidth": props["maxWidth"], "minWidth": props["minWidth"], "resizable": props["resizable"], "resizeLabel": props["resizeLabel"], "resizeStep": props["resizeStep"], "side": props["side"], "width": props["width"] };
