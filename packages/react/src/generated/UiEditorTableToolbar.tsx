...
export function UiEditorTableToolbar(props: UiEditorTableToolbarProps) {
  ...
  const componentProps: Record<string, unknown> = { "actions": props["actions"], "cellAlignment": props["cellAlignment"], "cellBackground": props["cellBackground"], "open": props["open"] };
