...
export function UiEditorMentionMenu(props: UiEditorMentionMenuProps) {
  ...
  const componentProps: Record<string, unknown> = { "anchorRect": props["anchorRect"], "items": props["items"], "loading": props["loading"], "open": props["open"], "query": props["query"], "selectedIndex": props["selectedIndex"] };
