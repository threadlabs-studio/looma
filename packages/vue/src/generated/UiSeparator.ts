...
const explicitProps = (): Record<string, unknown> => {
  ...
  return { "orientation": passed("orientation", "orientation") ? valueorientation : undefined };
};
...
onMounted(() => {
  ...
  detach = attachLoomaComponent(root.value, definition, "ui-separator", explicitProps());
});
watchEffect(() => {
