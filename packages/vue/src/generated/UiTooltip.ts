...
export default /*@__PURE__*/_defineComponent({
  ...
  props: {
    ...
    toggleOnClick: { type: [Boolean, null], required: false, default: false }
  },
  emits: ["open", "close"],
...
watchEffect(() => {
  if (root.value == null) return;
  for (const name of ["defaultOpen","for","hideDelay","open","placement","showDelay","toggleOnClick"]) (root.value as unknown as Record<string, unknown>)[name] = props[name as keyof typeof props];
});
onUnmounted(() => {
