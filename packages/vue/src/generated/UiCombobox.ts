...
watchEffect(() => {
  if (root.value == null) return;
  for (const name of ["allowCreate","allowFreeText","clearable","config","disabled","disclosure","help","label","labelVisibility","multiple","name","placeholder","query","readonly","required","size","tokenSeparators","value"]) (root.value as unknown as Record<string, unknown>)[name] = props[name as keyof typeof props];
});
__expose({
...
return (_ctx: any,_cache: any) => {
  return (_openBlock(), _createElementBlock("div", _mergeProps(_ctx.$attrs, {
    ...
    _cache[9] || (_cache[9] = _createElementVNode("select", {
