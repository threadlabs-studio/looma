...
const explicitProps = (): Record<string, unknown> => {
  ...
  return { "checked": passed("checked", "checked") ? valuechecked : undefined, "disabled": passed("disabled", "disabled") ? valuedisabled : undefined, "name": passed("name", "name") ? valuename : undefined, "required": passed("required", "required") ? valuerequired : undefined, "value": passed("value", "value") ? valuevalue : undefined };
};
...
onMounted(() => {
  ...
  detach = attachLoomaComponent(root.value, definition, "ui-radio", explicitProps());
