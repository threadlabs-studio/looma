...
export function createUiCombobox(options = {}) {
  ...
  const value1 = componentProps["tokenSeparators"] === undefined ? undefined : componentProps["tokenSeparators"];
  if (value1 !== undefined) element["tokenSeparators"] = value1;
  const value2 = componentProps["config"] === undefined ? undefined : componentProps["config"];
  if (value2 !== undefined) element["config"] = value2;
  const value3 = componentProps["size"] === undefined ? "md" : componentProps["size"];
  if (value3 === null || value3 === undefined) element.removeAttribute("data-size");
  else element.setAttribute("data-size", String(value3));
  ...
  const value4 = componentProps["placeholder"] === undefined ? "" : componentProps["placeholder"];
  if (value4 === null || value4 === undefined) element4.removeAttribute("placeholder");
  else element4.setAttribute("placeholder", String(value4));
  const value5 = componentProps["name"] === undefined ? "" : componentProps["name"];
  if (value5 === null || value5 === undefined) element4.removeAttribute("name");
  else element4.setAttribute("name", String(value5));
  const value6 = componentProps["disabled"] === undefined ? false : componentProps["disabled"];
  if (value6 === true) element4.setAttribute("disabled", "");
  else element4.removeAttribute("disabled");
  const value7 = componentProps["readonly"] === undefined ? false : componentProps["readonly"];
  if (value7 === true) element4.setAttribute("readonly", "");
  else element4.removeAttribute("readonly");
  const value8 = componentProps["required"] === undefined ? false : componentProps["required"];
  if (value8 === true) element4.setAttribute("required", "");
  ...
  const value9 = componentProps["disabled"] === undefined ? false : componentProps["disabled"];
  if (value9 === true) element6.setAttribute("disabled", "");
  ...
  const element16 = document.createElement("select");
  element16.setAttribute("class", "authored-options");
  element16.setAttribute("hidden", "");
  element16.setAttribute("aria-hidden", "true");
  element16.setAttribute("tabindex", "-1");
