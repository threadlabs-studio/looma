...
export function createUiCombobox(options = {}) {
  ...
  const value1 = componentProps["placeholder"] === undefined ? "" : componentProps["placeholder"];
  if (value1 === null || value1 === undefined) element4.removeAttribute("placeholder");
  else element4.setAttribute("placeholder", String(value1));
  const value2 = componentProps["name"] === undefined ? "" : componentProps["name"];
  if (value2 === null || value2 === undefined) element4.removeAttribute("name");
  ...
  const value4 = componentProps["readonly"] === undefined ? false : componentProps["readonly"];
  if (value4 === true) element4.setAttribute("readonly", "");
  else element4.removeAttribute("readonly");
  const value5 = componentProps["required"] === undefined ? false : componentProps["required"];
