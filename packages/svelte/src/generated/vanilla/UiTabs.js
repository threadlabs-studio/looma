...
export function createUiTabs(options = {}) {
  ...
  const value1 = componentProps["stretch"] === undefined ? false : componentProps["stretch"];
  ...
  const value2 = componentProps["label"] === undefined ? "Tabs" : componentProps["label"];
  if (value2 === null || value2 === undefined) element0.removeAttribute("aria-label");
